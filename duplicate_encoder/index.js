...
// string. Ignore capitalization when determining if a
...
// "...It Should encode XXX", the "XXX" is actually
// the expected result, not the input! (these languages
//   are locked so that's not possible to correct it).
